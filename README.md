...
### Note that Certificate and Private key will be generated by certbot later. And so that, we will uncomment ssl_certificate path and ssl_certificate_key to setup key paths properly.
## Generate certificate and private key
```bash
sudo certbot certonly --nginx
```
## Choose your domain name and press enter
```bash
